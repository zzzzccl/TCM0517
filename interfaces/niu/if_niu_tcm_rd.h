...
struct if_niu_tcm_rd
{
    ...
    uint8_t  size  : 3;  // Bytes per beat = 2^size. Fixed 7.
    ...
    friend std::ostream &operator<<(std::ostream &os, const if_niu_tcm_rd &req)
    {
